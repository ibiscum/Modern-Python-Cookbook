...
if __name__ == "__main__":
    ...
    # print( vars(leg_1) )
    print(
        "option 1 {leg.distance:.1f}nm at {leg.rate:.2f}kt = {leg.time:.2f}hr".format(
            leg=leg_1
        )
    )
    leg_1.distance = 38.2
    print(
        "option 2 {leg.distance:.1f}nm at {leg.rate:.2f}kt = {leg.time:.2f}hr".format(
            leg=leg_1
        )
    )
    leg_1.time = 7
    print(
        "option 3 {leg.distance:.1f}nm at {leg.rate:.2f}kt = {leg.time:.2f}hr".format(
            leg=leg_1
        )
    )
